...
- **B-307 — Record-level provenance drawer.** (External review, 2026-08-28;
  ...
  edition/table-level citations require possessing the governing documents
  (standards are paywalled) — the schema and drawer UI can ship first with
  honest "edition unrecorded" states, populated as documents are acquired.
