 ...
 * the maintainers are confident of are listed — GB and GOST counterparts
 * are OMITTED rather than guessed (an honest gap, ground rule 4). Every
 * equivalence is NOMINAL: composition and property limits differ between
 * standards; verify against the target standard's own tables before use.
 */
